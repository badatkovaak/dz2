...
class LinkController extends AbstractController
{
    ...
    public function createLinkRoute(Request $request, LinkRepository $rep, Security $security, ValidatorInterface $val): Response
    {
        if (!LinkService::createLinkHandler($request, $security, $rep, $val)) {
