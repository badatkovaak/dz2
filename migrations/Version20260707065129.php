 ...
 */
final class Version20260707065129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO link (id, short_url, long_url, creation_time, last_use_time, use_count) SELECT id, short_url, long_url, creation_time, last_use_time, use_count FROM __temp__link');
