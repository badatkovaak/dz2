 ...
 */
final class Version20260706175141 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS link (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, short_url VARCHAR(255) NOT NULL, long_url VARCHAR(255) NOT NULL, creation_time DATETIME NOT NULL, last_use_time DATETIME DEFAULT NULL, use_count INTEGER NOT NULL)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE link');
        $this->addSql('CREATE TABLE IF NOT EXISTS link (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, short_url VARCHAR(255) NOT NULL, long_url VARCHAR(255) NOT NULL, creation_time DATETIME NOT NULL, last_used_time DATETIME DEFAULT NULL, use_count INTEGER NOT NULL)');
